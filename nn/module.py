...
def register_module_buffer_registration_hook(
    ...
    Returns:
        :class:`torch.utils.RemovableHandle`:
...
class Module:
    ...
    def register_parameter(self, name: str, param: Optional[Parameter]) -> None:
        ...
        #         "(Parameter or None required)".format(
    ...
    def to_empty(self: T, *, device: Union[str, device]) -> T:
        ...
        return self._apply(lambda t: "empty")
    ...
    def to(self, *args, **kwargs):
        ...
        Its signature is similar to :meth:`Tensor.to`, but only accepts
        ...
        Args:
            ...
            tensor (Tensor): Tensor whose dtype and device are the desired
    ...
    def register_backward_hook(
        ...
        This function is deprecated in favor of :meth:`~Module.register_full_backward_hook` and
    ...
    def _maybe_warn_non_full_backward_hook(self, inputs, result, grad_fn):
        if not isinstance(result, Tensor):
            if not (
                ...
                and all(isinstance(r, Tensor) for r in result)
            ):
                warnings.warn(
        ...
        if not isinstance(inputs, Tensor):
            if not (
                ...
                and all(isinstance(i, Tensor) for i in inputs)
            ):
                warnings.warn(
    ...
    def __setattr__(self, name: str, value: Union[Tensor, "Module"]) -> None:
        ...
        #             "(Parameter or None expected)".format(
        ...
        #     self.register_parameter(name, value)
            ...
            #             "(Module or None expected)".format(
            #                 torch.typename(value), name
            #             )
            #         )
            #     for hook in _global_module_registration_hooks.values():
    ...
    def _save_to_state_dict(self, destination, prefix, keep_vars):
        ...
        submodule in :meth:`~Module.state_dict`.
    ...
    def state_dict(self, *args, destination=None, prefix="", keep_vars=False):
        ...
        if len(args) > 0:
            ...
            warnings.warn(
                ...
                "https://pytorch.org/docs/master/generated/Module.html#Module.state_dict"
                " for details."
            )
    ...
    def _load_from_state_dict(
        ...
        in :meth:`~Module.load_state_dict`. Metadata saved for this
        ...
        .. note::
            ...
            :attr:`state_dict` to :meth:`~Module.load_state_dict`. So
            it can be modified.
        ...
        for name, param in local_state.items():
            ...
            if key in state_dict:
                ...
                is_param_lazy = Parameter.is_lazy(param)
    ...
    def eval(self: T) -> T:
        ...
        This is equivalent with :meth:`self.train(False) <Module.train>`.
    ...
    def share_memory(self: T) -> T:
        r"""See :meth:`Tensor.share_memory_`"""
